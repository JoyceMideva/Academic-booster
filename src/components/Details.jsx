...
function Details() {
  return (
    <div className="container mx-auto bg-[#3871c1] h-[100vh]">
      <div className="">
        <input
          type="text"
      ...
      <div>
        ...
        <button className=" text-[#45C9A1] mx-28">Forgot Password?</button>
      </div>

      <button
        className="bg-teal-500 my-5 text-lg font-bold text-white py-4 px-2 w-[60%] rounded-full mx-16"
        type="submit"
      >
        Sign In
      </button>
      ...
      <div className="flex justify-center w-[70%] gap-3">
        ...
        <button className="text-[#45C9A1] text-2xl">Sign Up Free</button>
      </div>
    </div>
  );
}
