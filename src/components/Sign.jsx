      ...
      <div className="flex h-[86vh]">
        ...
        <div className=" flex-1 bg-[#3871c1]">
          ...
          {formErrors.firstName && (
              <p className="text-red-500 text-center text-2xl">{formErrors.firstName}</p>
            )}
            ...
            {formErrors.password && (
              <p className="text-red-500 text-center text-2xl my-1">{formErrors.password}</p>
            )}
            <div className="flex justify-center my-7">
              <input
                onChange={(e) => handleChange(e)}
            ...
            <div className="flex justify-center my-5">
              <button
                ...
                className="bg-white my-1 text-lg font-bold text-[#3871c1] py-4 px-2 w-[50%] rounded-full mx-16"
                type="submit"
              >
                Create Account
              </button>
            ...
            <div className="flex justify-center w-[70%] gap-3">
              <p className="text-2xl text-center">Already Have An Account?</p>
              <Link to="/login">
                {" "}
