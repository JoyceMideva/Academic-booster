  ...
  return (
          ...
          <div className=" flex w-[70%] gap-10">
            <div>
              ...
              <input
                ...
                className="w-[90%] mx-6 outline-none rounded-md border-2 p-4 my-5"
                name="firstName"
              />
            </div>
            <div className=" ">
              ...
              <input
                ...
                className="w-[100%] outline-none rounded-md border-2 p-4 my-5"
                name="lastName"
              />
            </div>
      </div>
      <div className="mx-5 justify-center">
            ...
            <input
              ...
              className="outline-none rounded-md border-2 p-4 w-[70%] my-3"
              name="email"
            />
         
            
              <input
                className="flex-1 outline-none my-3 p-4 px-2 border-2 border-grey-400 rounded-md w-[70%]"
                type="password"
